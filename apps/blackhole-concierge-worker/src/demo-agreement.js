...
function buildPdfBytes({ contact = {}, product = {}, selectionNumber = 1, agreementId = "DEMO-PENDING", brandName = "Everything Built Custom", assistantName = "EBC AI" } = {}) {
  const fullName = `${contact.firstName || ""} ${contact.lastName || ""}`.trim() || "Customer";
  const commands = [];

  commands.push(fillRect(0, 637, 612, 155, "#111111"));
  commands.push(fillRect(38, 672, 56, 56, "#1c75bc"));
  commands.push(text(52, 690, 25, "EBC", "F2", "#ffffff"));
  ...
  commands.push(text(38, 412, 14, "Selected EBC Service", "F2", "#111111"));
  ...
  commands.push(fillRect(38, 176, 536, 88, "#f2f8fc"));
...
export function buildDemoEnvelope({ contact = {}, product = {}, selectionNumber = 1, agreementId = "DEMO-PENDING", brandName = "Everything Built Custom", assistantName = "EBC AI" } = {}) {
  const fullName = `${contact.firstName || ""} ${contact.lastName || ""}`.trim() || "Customer";
